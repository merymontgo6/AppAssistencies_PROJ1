...
public class safataEntradaProf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_safata_entrada_prof);
    ...
    private void loadNotifications(int page) {
        ...
        if (allNotifications != null && !allNotifications.isEmpty()) {
            ...
            Log.d("safataEntradaProf", "No notifications found.");
        }
    }
}